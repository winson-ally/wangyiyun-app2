...
export default createStore({
  ...
  mutations: {
    ...
    updateCurrentTime:function(state,value){//歌词操作
  ...
  actions: {
    getLyric: async function ({commit}, value) {
      let res = await getMusicLyric(value)
      console.log(res);
      commit("updateLyricList",res.data.lrc)
      // context.commit是常规写法
      //{commit} commit是简化写法
    },//登录方法
    getLogin:async function({commit},value){
